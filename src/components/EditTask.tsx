...
const NewTask = () => {
    ...
    return (
        <>
            <div className="fixed top-1/2 -translate-y-1/2 right-5 bg-[#e66842] border-4 border-white/100 shadow-lg rounded-full p-2">
                <ul className="space-y-2">
                    <li><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="white" className="w-[30px] h-[30px] mx-auto hover:bg-white/20 p-1 rounded-full cursor-pointer" onClick={handleOpen}>
                        <path strokeLinecap="round" strokeLinejoin="round" d="M12 4.5v15m7.5-7.5h-15" />
                    </svg>
                    </li>
                    <li><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="white" className="w-[30px] h-[30px] p-1 mx-auto hover:bg-white/20 rounded-full cursor-pointer">
            ...
            >
                <Box className="w-[100%] max-w-[800px] absolute top-1/2 -translate-y-1/2 left-1/2 -translate-x-1/2 bg-[#ff7043] border-black/30 border-4 text-white outline-none p-4 rounded overflow-hidden">
                    ...
                    <div className="my-4 space-y-2">
                        ...
                        <div className="flex items-center gap-2">
                            <div className="border-white border-2 border-dotted rounded px-2 w-full py-4 flex items-center justify-center flex-col">
                                <label htmlFor="file" className="cursor-pointer text-center">Choose File<br/>{formData.fileNames}</label>
